...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/cart.vue?vue&type=template&id=122f8bba&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nav',{staticClass:"sticky top-0"}),_vm._ssrNode(" <div class=\"w-4/5 sm:w-1/2 mx-auto\" data-v-122f8bba><h1 class=\"m-5 font-bold text-lg\" data-v-122f8bba>Your Cart</h1></div> "+(_vm._ssrList((_vm.getCart),function(item){return ("<div class=\"w-4/5 sm:w-1/2 flex items-center space-x-3 mx-auto shadow-lg m-5 p-3\" data-v-122f8bba><div data-v-122f8bba><img"+(_vm._ssrAttr("src",("" + (item.url))))+" alt class=\"h-24\" data-v-122f8bba></div> <div data-v-122f8bba><p data-v-122f8bba>"+_vm._ssrEscape("\n        "+_vm._s(item.name)+"\n      ")+"</p> <p data-v-122f8bba>"+_vm._ssrEscape("\n        "+_vm._s(_vm._f("formatQuantity")(item.quantity))+"\n      ")+"</p> <button class=\"button--delete\" data-v-122f8bba>\n        Delete\n      </button></div></div>")}))+" <div class=\"w-4/5 sm:w-1/2 mb-2 mx-auto\" data-v-122f8bba><p data-v-122f8bba><span data-v-122f8bba>Total: </span>"+_vm._ssrEscape(" "+_vm._s(_vm._f("formatPrice")(_vm.formatCartTotal(_vm.getCartTotal)))+"\n    ")+"</p> <button class=\"button--green mx-auto\""+(_vm._ssrStyle(null,null, { display: (_vm.getCartTotal > 0) ? '' : 'none' }))+" data-v-122f8bba>\n      checkout\n    </button></div> "),_c('Ads',{staticClass:"mx-auto sm:m-10"}),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/cart.vue?vue&type=template&id=122f8bba&scoped=true&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(4);

// EXTERNAL MODULE: external "@stripe/stripe-js"
var stripe_js_ = __webpack_require__(40);
...
/* harmony default export */ var cartvue_type_script_lang_js_ = ({
  ...
  computed: { ...Object(external_vuex_["mapGetters"])(['getCart', 'getCartTotal'])
  },
  ...
  methods: {
    async handleSubmit(e) {
      ...
      e.preventDefault();
      const response = await this.$http.$post(`https://enigmatic-peak-00809.herokuapp.com/orders`, {
      ...
      const stripePromise = Object(stripe_js_["loadStripe"])(PROCESS.env.STRIPE_KEY);
    ...
    ...Object(external_vuex_["mapActions"])(['deleteCartItem'])
  },
  filters: {
    formatPrice(price) {
      return `$${price}`;
...
installComponents(component, {Nav: __webpack_require__(45).default,Ads: __webpack_require__(46).default,Footer: __webpack_require__(47).default})
