...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/women.vue?vue&type=template&id=53dec528&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nav',{staticClass:"sticky top-0"}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"sm:w-11/12 md:w-4/5 mx-auto\" data-v-53dec528>","</div>",[_vm._ssrNode("<h1 class=\"m-5 font-bold text-lg\" data-v-53dec528>Women's Collection</h1> "),_vm._ssrNode("<div class=\"flex justify-center text-center mx-auto\" data-v-53dec528>","</div>",[_c('Featured',{attrs:{"data":_vm.womenProducts}})],1)],2),_vm._ssrNode(" "),_c('Ads',{staticClass:"mx-auto sm:m-10"}),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/women.vue?vue&type=template&id=53dec528&scoped=true&
...
/* harmony default export */ var womenvue_type_script_lang_js_ = ({
  async asyncData({
    ...
    try {
      const response = await $strapi.$products.find([['category.name', 'women']]);
  ...
  computed: { ...Object(external_vuex_["mapGetters"])(['womenProducts'])
  }
});
