...
/******/ 			var chunk = require("./" + ({"1":"components/ads","2":"components/featured","3":"components/footer","4":"components/hero-section","5":"components/logo","6":"components/nav","7":"components/news-letter","8":"components/products","9":"pages/all","10":"pages/cart","11":"pages/index","12":"pages/men","13":"pages/products/_products","14":"pages/women"}[chunkId]||chunkId) + ".js");
...
module.exports = JSON.parse("{\"title\":\"e-commerce\",\"meta\":[{\"hid\":\"charset\",\"charset\":\"utf-8\"},{\"hid\":\"viewport\",\"name\":\"viewport\",\"content\":\"width=device-width, initial-scale=1\"},{\"hid\":\"mobile-web-app-capable\",\"name\":\"mobile-web-app-capable\",\"content\":\"yes\"},{\"hid\":\"apple-mobile-web-app-title\",\"name\":\"apple-mobile-web-app-title\",\"content\":\"e-commerce\"},{\"hid\":\"description\",\"name\":\"description\",\"content\":\"```bash\\r # install dependencies\\r $ yarn install\"},{\"hid\":\"og:type\",\"name\":\"og:type\",\"property\":\"og:type\",\"content\":\"website\"},{\"hid\":\"og:title\",\"name\":\"og:title\",\"property\":\"og:title\",\"content\":\"e-commerce\"},{\"hid\":\"og:site_name\",\"name\":\"og:site_name\",\"property\":\"og:site_name\",\"content\":\"e-commerce\"},{\"hid\":\"og:description\",\"name\":\"og:description\",\"property\":\"og:description\",\"content\":\"```bash\\r # install dependencies\\r $ yarn install\"}],\"link\":[{\"hid\":\"shortcut-icon\",\"rel\":\"shortcut icon\",\"href\":\"/_nuxt/icons/icon_64x64.5f6a36.png\"},{\"hid\":\"apple-touch-icon\",\"rel\":\"apple-touch-icon\",\"href\":\"/_nuxt/icons/icon_512x512.5f6a36.png\",\"sizes\":\"512x512\"},{\"rel\":\"manifest\",\"href\":\"/_nuxt/manifest.84213484.json\",\"hid\":\"manifest\"}],\"htmlAttrs\":{\"lang\":\"en\"}}");

/***/ }),
/* 26 */
/***/ (function(module, exports) {

module.exports = require("vue-swal");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */html{line-height:1.15;-webkit-text-size-adjust:100%}body{margin:0}main{display:block}h1{font-size:2em;margin:.67em 0}hr{box-sizing:content-box;height:0;overflow:visible}pre{font-family:monospace,monospace;font-size:1em}a{background-color:transparent}abbr[title]{border-bottom:none;text-decoration:underline;-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b,strong{font-weight:bolder}code,kbd,samp{font-family:monospace,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}img{border-style:none}button,input,optgroup,select,textarea{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button,input{overflow:visible}button,select{text-transform:none}[type=button],[type=reset],[type=submit],button{-webkit-appearance:button}[type=button]::-moz-focus-inner,[type=reset]::-moz-focus-inner,[type=submit]::-moz-focus-inner,button::-moz-focus-inner{border-style:none;padding:0}[type=button]:-moz-focusring,[type=reset]:-moz-focusring,[type=submit]:-moz-focusring,button:-moz-focusring{outline:1px dotted ButtonText}fieldset{padding:.35em .75em .625em}legend{box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}progress{vertical-align:baseline}textarea{overflow:auto}[type=checkbox],[type=radio]{box-sizing:border-box;padding:0}[type=number]::-webkit-inner-spin-button,[type=number]::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}[type=search]::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}details{display:block}summary{display:list-item}[hidden],template{display:none}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}button{background-color:transparent;background-image:none}button:focus{outline:1px dotted;outline:5px auto -webkit-focus-ring-color}fieldset,ol,ul{margin:0;padding:0}ol,ul{list-style:none}html{font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,BlinkMacSystemFont,\"Segoe UI\",\"Helvetica Neue\",Arial,\"Noto Sans\",\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\",\"Noto Color Emoji\";line-height:1.5}*,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}hr{border-top-width:1px}img{border-style:solid}textarea{resize:vertical}input::-moz-placeholder,textarea::-moz-placeholder{color:#a0aec0}input:-ms-input-placeholder,textarea:-ms-input-placeholder{color:#a0aec0}input::placeholder,textarea::placeholder{color:#a0aec0}[role=button],button{cursor:pointer}table{border-collapse:collapse}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}button,input,optgroup,select,textarea{padding:0;line-height:inherit;color:inherit}code,kbd,pre,samp{font-family:Menlo,Monaco,Consolas,\"Liberation Mono\",\"Courier New\",monospace}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}.container{width:100%}@media (min-width:640px){.container{max-width:640px}}@media (min-width:768px){.container{max-width:768px}}@media (min-width:1024px){.container{max-width:1024px}}@media (min-width:1280px){.container{max-width:1280px}}.space-x-3>:not(template)~:not(template){--space-x-reverse:0;margin-right:calc(0.75rem*var(--space-x-reverse));margin-left:calc(0.75rem*(1 - var(--space-x-reverse)))}.space-x-5>:not(template)~:not(template){--space-x-reverse:0;margin-right:calc(1.25rem*var(--space-x-reverse));margin-left:calc(1.25rem*(1 - var(--space-x-reverse)))}.space-x-6>:not(template)~:not(template){--space-x-reverse:0;margin-right:calc(1.5rem*var(--space-x-reverse));margin-left:calc(1.5rem*(1 - var(--space-x-reverse)))}.bg-primary{--bg-opacity:1;background-color:#9c7474;background-color:rgba(156,116,116,var(--bg-opacity))}.bg-button{--bg-opacity:1;background-color:#bec1a6;background-color:rgba(190,193,166,var(--bg-opacity))}.bg-cover{background-size:cover}.border-black{--border-opacity:1;border-color:#000;border-color:rgba(0,0,0,var(--border-opacity))}.border-solid{border-style:solid}.border{border-width:1px}.border-t-0{border-top-width:0}.border-r-0{border-right-width:0}.border-l-0{border-left-width:0}.flex{display:flex}.table{display:table}.flex-col{flex-direction:column}.items-center{align-items:center}.justify-center{justify-content:center}.flex-shrink{flex-shrink:1}.font-light{font-weight:300}.font-bold{font-weight:700}.h-24{height:6rem}.h-48{height:12rem}.text-xs{font-size:.75rem}.text-sm{font-size:.875rem}.text-lg{font-size:1.125rem}.text-5xl{font-size:3rem}.m-2{margin:.5rem}.m-3{margin:.75rem}.m-5{margin:1.25rem}.m-8{margin:2rem}.m-10{margin:2.5rem}.my-2{margin-top:.5rem;margin-bottom:.5rem}.mx-6{margin-left:1.5rem;margin-right:1.5rem}.mx-auto{margin-left:auto;margin-right:auto}.mb-2{margin-bottom:.5rem}.mb-3{margin-bottom:.75rem}.mb-4{margin-bottom:1rem}.ml-5{margin-left:1.25rem}.ml-6{margin-left:1.5rem}.mt-10{margin-top:2.5rem}.max-h-screen{max-height:100vh}.min-h-screen{min-height:100vh}.outline-none{outline:2px solid transparent;outline-offset:2px}.p-1{padding:.25rem}.p-2{padding:.5rem}.p-3{padding:.75rem}.p-5{padding:1.25rem}.px-2{padding-left:.5rem;padding-right:.5rem}.py-8{padding-top:2rem;padding-bottom:2rem}.pt-3{padding-top:.75rem}.fixed{position:fixed}.absolute{position:absolute}.relative{position:relative}.sticky{position:sticky}.top-0{top:0}.right-0{right:0}.bottom-0{bottom:0}.left-0{left:0}.shadow-md{box-shadow:0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -1px rgba(0,0,0,.06)}.shadow-lg{box-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05)}.shadow-xl{box-shadow:0 20px 25px -5px rgba(0,0,0,.1),0 10px 10px -5px rgba(0,0,0,.04)}.text-center{text-align:center}.text-white{--text-opacity:1;color:#fff;color:rgba(255,255,255,var(--text-opacity))}.w-4\\/5{width:80%}.z-0{z-index:0}.z-10{z-index:10}.gap-3{grid-gap:.75rem;gap:.75rem}.gap-6{grid-gap:1.5rem;gap:1.5rem}.grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}@-webkit-keyframes spin{to{transform:rotate(1turn)}}@keyframes spin{to{transform:rotate(1turn)}}@-webkit-keyframes ping{75%,to{transform:scale(2);opacity:0}}@keyframes ping{75%,to{transform:scale(2);opacity:0}}@-webkit-keyframes pulse{50%{opacity:.5}}@keyframes pulse{50%{opacity:.5}}@-webkit-keyframes bounce{0%,to{transform:translateY(-25%);-webkit-animation-timing-function:cubic-bezier(.8,0,1,1);animation-timing-function:cubic-bezier(.8,0,1,1)}50%{transform:none;-webkit-animation-timing-function:cubic-bezier(0,0,.2,1);animation-timing-function:cubic-bezier(0,0,.2,1)}}@keyframes bounce{0%,to{transform:translateY(-25%);-webkit-animation-timing-function:cubic-bezier(.8,0,1,1);animation-timing-function:cubic-bezier(.8,0,1,1)}50%{transform:none;-webkit-animation-timing-function:cubic-bezier(0,0,.2,1);animation-timing-function:cubic-bezier(0,0,.2,1)}}@media (min-width:640px){.sm\\:container{width:100%}}@media (min-width:640px) and (min-width:640px){.sm\\:container{max-width:640px}}@media (min-width:640px) and (min-width:768px){.sm\\:container{max-width:768px}}@media (min-width:640px) and (min-width:1024px){.sm\\:container{max-width:1024px}}@media (min-width:640px) and (min-width:1280px){.sm\\:container{max-width:1280px}}@media (min-width:640px){.sm\\:space-x-20>:not(template)~:not(template){--space-x-reverse:0;margin-right:calc(5rem*var(--space-x-reverse));margin-left:calc(5rem*(1 - var(--space-x-reverse)))}.sm\\:flex{display:flex}.sm\\:grid{display:grid}.sm\\:hidden{display:none}.sm\\:flex-row{flex-direction:row}.sm\\:items-center{align-items:center}.sm\\:text-2xl{font-size:1.5rem}.sm\\:m-0{margin:0}.sm\\:m-2{margin:.5rem}.sm\\:m-3{margin:.75rem}.sm\\:m-6{margin:1.5rem}.sm\\:m-10{margin:2.5rem}.sm\\:mt-0{margin-top:0}.sm\\:p-0{padding:0}.sm\\:pl-20{padding-left:5rem}.sm\\:w-1\\/2{width:50%}.sm\\:w-11\\/12{width:91.666667%}.sm\\:grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}}@media (min-width:768px){.md\\:container{width:100%}}@media (min-width:768px) and (min-width:640px){.md\\:container{max-width:640px}}@media (min-width:768px) and (min-width:768px){.md\\:container{max-width:768px}}@media (min-width:768px) and (min-width:1024px){.md\\:container{max-width:1024px}}@media (min-width:768px) and (min-width:1280px){.md\\:container{max-width:1280px}}@media (min-width:768px){.md\\:space-x-20>:not(template)~:not(template){--space-x-reverse:0;margin-right:calc(5rem*var(--space-x-reverse));margin-left:calc(5rem*(1 - var(--space-x-reverse)))}.md\\:text-6xl{font-size:4rem}.md\\:m-4{margin:1rem}.md\\:m-5{margin:1.25rem}.md\\:m-20{margin:5rem}.md\\:mx-10{margin-left:2.5rem;margin-right:2.5rem}.md\\:p-20{padding:5rem}.md\\:w-4\\/5{width:80%}.md\\:grid-cols-3{grid-template-columns:repeat(3,minmax(0,1fr))}}@media (min-width:1024px){.lg\\:container{width:100%}}@media (min-width:1024px) and (min-width:640px){.lg\\:container{max-width:640px}}@media (min-width:1024px) and (min-width:768px){.lg\\:container{max-width:768px}}@media (min-width:1024px) and (min-width:1024px){.lg\\:container{max-width:1024px}}@media (min-width:1024px) and (min-width:1280px){.lg\\:container{max-width:1280px}}@media (min-width:1280px){.xl\\:container{width:100%}}@media (min-width:1280px) and (min-width:640px){.xl\\:container{max-width:640px}}@media (min-width:1280px) and (min-width:768px){.xl\\:container{max-width:768px}}@media (min-width:1280px) and (min-width:1024px){.xl\\:container{max-width:1024px}}@media (min-width:1280px) and (min-width:1280px){.xl\\:container{max-width:1280px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{font-family:\"Nunito\";font-size:16px;word-spacing:1px;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;box-sizing:border-box}*,:after,:before{box-sizing:border-box;margin:0}.button--hero{color:#fff}.button--green,.button--hero{display:inline-block;text-decoration:none;padding:10px 30px}.button--green{border:1px solid #3b8070;color:#3b8070}.button--green:hover{color:#fff;background-color:#3b8070}.button--grey{display:inline-block;border:1px solid #35495e;color:#35495e;text-decoration:none;padding:10px 30px;margin-left:15px}.button--delete,.button--grey:hover{color:#fff;background-color:#35495e}.button--delete{display:inline-block;border:1px solid #35495e;padding:5px}button:focus{outline:none}.container{width:80%}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const mutations = {
  ...
  removeCartItem: (state, id) => state.cartItems.splice(state.cartItems.findIndex(el => el.id === id), 1)
};
...
const _0d27dfa0 = () => interopDefault(__webpack_require__.e(/* import() | pages/all */ 9).then(__webpack_require__.bind(null, 63)));

const _2fa8aeb1 = () => interopDefault(__webpack_require__.e(/* import() | pages/cart */ 10).then(__webpack_require__.bind(null, 64)));

const _7c1ce955 = () => interopDefault(__webpack_require__.e(/* import() | pages/men */ 12).then(__webpack_require__.bind(null, 65)));

const _2b38cc86 = () => interopDefault(__webpack_require__.e(/* import() | pages/women */ 14).then(__webpack_require__.bind(null, 66)));

const _68dcb85e = () => interopDefault(__webpack_require__.e(/* import() | pages/products/_products */ 13).then(__webpack_require__.bind(null, 67)));

const _e98d9ede = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 11).then(__webpack_require__.bind(null, 68)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=f2bf72ae&
var defaultvue_type_template_id_f2bf72ae_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nuxt')],1)}
var defaultvue_type_template_id_f2bf72ae_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=f2bf72ae&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_f2bf72ae_render,
  defaultvue_type_template_id_f2bf72ae_staticRenderFns,
  false,
...
const components = {
  Ads: () => __webpack_require__.e(/* import() | components/ads */ 1).then(__webpack_require__.bind(null, 46)).then(c => c.default || c),
  Featured: () => __webpack_require__.e(/* import() | components/featured */ 2).then(__webpack_require__.bind(null, 50)).then(c => c.default || c),
  Footer: () => __webpack_require__.e(/* import() | components/footer */ 3).then(__webpack_require__.bind(null, 47)).then(c => c.default || c),
  HeroSection: () => __webpack_require__.e(/* import() | components/hero-section */ 4).then(__webpack_require__.bind(null, 57)).then(c => c.default || c),
  Logo: () => __webpack_require__.e(/* import() | components/logo */ 5).then(__webpack_require__.bind(null, 69)).then(c => c.default || c),
  Nav: () => __webpack_require__.e(/* import() | components/nav */ 6).then(__webpack_require__.bind(null, 45)).then(c => c.default || c),
  NewsLetter: () => __webpack_require__.e(/* import() | components/news-letter */ 7).then(__webpack_require__.bind(null, 58)).then(c => c.default || c),
  Products: () => __webpack_require__.e(/* import() | components/products */ 8).then(__webpack_require__.bind(null, 56)).then(c => c.default || c)
};
...
var external_destr_ = __webpack_require__(12);
...
/* harmony default export */ var strapi = (async function (ctx, inject) {
  ["productos", "ordenes", "suscriptores"].forEach(entity => {
    let key;
    let type = 'collection';
...
// EXTERNAL MODULE: external "vue-swal"
var external_vue_swal_ = __webpack_require__(26);
var external_vue_swal_default = /*#__PURE__*/__webpack_require__.n(external_vue_swal_);

// CONCATENATED MODULE: ./plugins/vue-swal.js


external_vue_default.a.use(external_vue_swal_default.a);
...
/* Plugins */
 ...
 // Source: ..\\plugins\\vue-swal (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof /* Cannot get final name for export "default" in "./plugins/vue-swal.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./plugins/vue-swal.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
